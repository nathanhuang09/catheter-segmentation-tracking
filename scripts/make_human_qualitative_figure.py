...
def main():
    ...
    if args.filename:
        ...
        fig.subplots_adjust(left=.09, right=.995, top=.88, bottom=.02)
        ...
        metadata = {"description": "Selected successful example; not representative of the entire dataset.",
                    ...
                    "panel_order": order, "annotations_modified": False, "prediction_postprocessed": False}
